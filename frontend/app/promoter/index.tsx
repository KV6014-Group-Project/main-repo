  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      <ScrollView className="flex-1" contentContainerClassName="p-5">
        ...
        <Text className="text-sm text-gray-500 text-center mb-8">Share events with your community</Text>

        <View className="bg-neutral-100 rounded-xl p-5 mb-5">
          <Text className="text-lg font-semibold mb-2">Your Events</Text>
          <Text className="text-sm text-gray-500">No events assigned yet.</Text>
        </View>
